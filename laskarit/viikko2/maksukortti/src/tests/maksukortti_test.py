...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_edullisesti_vahentaa_saldoa_oikein(self):
    ...
    def test_lataa_rahaa_negatiivinen_summa_ei_muuta_kortin_saldoa(self):
        self.kortti.lataa_rahaa(-10)
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 10 euroa")

    def test_syo_edullisesti_onnistuu_vaikka_saldoa_vain_edullisen_lounaan_verran(self):
        self.kortti.arvo = 2.5
        self.kortti.syo_edullisesti()
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 0.0 euroa")

    def test_syo_maukkaasti_onnistuu_vaikka_saldoa_vain_maukkaan_lounaan_verran(self):
        self.kortti.arvo = 4.0
        self.kortti.syo_maukkaasti()
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 0.0 euroa")
